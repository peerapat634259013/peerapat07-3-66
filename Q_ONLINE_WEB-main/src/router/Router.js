...
import MainOpenScheduld from '../view/private/setting/openSchedule/MainOpenScheduld';
import FormOpenScheduld from '../view/private/setting/doctor/form/FormOpenSchedule';
        ...
        {role === 0 ? (
          ...
          <PrivateLayout>
            <Routes>
              ...
              <Route path="/admin/open_schedule" element={<MainOpenScheduld/>} />
              <Route path="/admin/open_schedule/form" element={<FormOpenScheduld/>} />
